...
import { Dropdown, Comment, Avatar } from 'antd';
import { useTranslation } from 'react-i18next';
import { convertHtmlToMention } from 'helpers/utils';
import { getListUsers } from 'services/comment';

const CommentEditor = ({ onSubmit, placeholder = '' }) => {
  ...
  return (
    <Comment
      ...
      content={
        <div
          className={'new_post'}
          style={{ maxWidth: '100%', margin: '0', fontSize: '14px !important' }}
        >
          {!showEditor ? (
            <div>
              <button
