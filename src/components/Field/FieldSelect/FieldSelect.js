...
export function Field({value, fieldId, label, isUsing, backgroundColor, onSelectField}) {
  return (
  ...
  return (
    <div className="field-select-content-container">
      ...
      <Tooltip title="">
        ...
        >
          <img style={{ marginRight: '5px' }} src={editStatusIcon} alt="edit" />
          {t('addEditLabels')}
        </div>
      </Tooltip>
    </div>
          ...
          <Tooltip title={selectedField?.label ?? ''}>
            <div style={{ height: '100%' }}>
              <div className="__field-select __field-select-show flex-jcenter">
                <span
                  className="text-too-long __label-select"
                  style={{
                    backgroundColor:
